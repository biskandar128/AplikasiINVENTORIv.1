...
class Petugas extends CI_Controller
{
    ...
    public function supplier()
    {
        if ($this->uri->segment(4) === 'view') {
            ...
            $data = [
                ...
                'content' => 'petugas/UpdateSupplier',
                'navlink' => 'supplier',
            ];
        } else {
            $data = [
                'supplier' => $this->crudModel->getData('supplier')->result(),
                'content' => 'petugas/supplier',
                'navlink' => 'supplier',
            ];
        }
    ...
    public function tambahSupplier()
    {
        ...
        redirect(site_url('petugas/supplier'));
    }
    ...
    public function perusahaan()
    {
        if ($this->uri->segment(4) === 'view') {
            ...
            $data = [
                ...
                'content' => 'petugas/UpdatePerusahaan',
                'navlink' => 'perusahaan',
            ];
        } else {
            $data = [
                'perusahaan' => $this->crudModel->getData('perusahaan')->result(),
                'content' => 'petugas/perusahaan',
                'navlink' => 'perusahaan',
            ];
        }
    ...
    public function tambahPerusahaan()
    {
        ...
        redirect(site_url('petugas/perusahaan'));
    }
    ...
    public function tambahBarang()
    {
        ...
        redirect(site_url('petugas/barang'));
    }
    ...
    public function kategori()
    {
        if ($this->uri->segment(4) === 'view') {
            ...
            $data = [
                ...
                'content' => 'petugas/UpdateKategori',
                'navlink' => 'kategori',
            ];
        } else {
            $data = [
                'kategori' => $this->crudModel->getData('kategori')->result(),
                'content' => 'petugas/kategori',
                'navlink' => 'kategori',
            ];
        }
    ...
    public function barang_masuk()
    {
        if ($this->uri->segment(4) === 'view') {
            ...
            $data = [
                ...
                'supplier' => $this->db->query('SELECT supplier_id, nama_supplier FROM supplier')->result(),
                'content' => 'petugas/UpdateBarangMasuk',
    ...
    public function tambahBarangMasuk()
    {
        ...
        redirect(site_url('petugas/barang_masuk'));
    }
    ...
    public function barang_keluar()
    {
        if ($this->uri->segment(4) === 'view') {
            ...
            $data = [
                ...
                'content' => 'petugas/UpdateBarangKeluar',
    ...
    public function tambahBarangKeluar()
    {
        ...
        redirect(site_url('petugas/barang_keluar'));
    }

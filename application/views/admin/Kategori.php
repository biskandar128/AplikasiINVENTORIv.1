                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>                          
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= site_url('admin/kategori/'.$value->kategori_id.'/view'); ?>" rel="tooltip" title="Edit Task" class="btn btn-primary btn-link btn-sm">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <a href="<?= site_url('admin/hapuskategori/'.$value->kategori_id); ?>" rel="tooltip" title="Remove" class="btn btn-danger btn-link btn-sm">

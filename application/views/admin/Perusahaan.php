                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $value->no_telp; ?></td>
                                    <td>
                                        <a href="<?= site_url('admin/perusahaan/'.$value->tujuan_id.'/view'); ?>" rel="tooltip" title="Edit Task" class="btn btn-primary btn-link btn-sm">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <a href="<?= site_url('admin/hapusPerusahaan/'.$value->tujuan_id); ?>" rel="tooltip" title="Remove" class="btn btn-danger btn-link btn-sm">
...
<div class="modal fade" id="modalPerusahaan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?= site_url('admin/tambahPerusahaan'); ?>" method="post">

                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-hover">
                            <thead class="text-primary" id="table_id">
                                <th>ID</th>
                                <th>Nama</th>
                                <th>Alamat</th>
                                <th>No Telp</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $value->no_telp; ?></td>
                                    <td>
                                        <a href="<?= site_url('admin/supplier/'.$value->supplier_id.'/view'); ?>" rel="tooltip" title="Edit Task" class="btn btn-primary btn-link btn-sm">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <a href="<?= site_url('admin/hapusSupplier/'.$value->supplier_id); ?>" rel="tooltip" title="Remove" class="btn btn-danger btn-link btn-sm">
...
<div class="modal fade" id="modalSupplier" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?= site_url('admin/tambahSupplier'); ?>" method="post">

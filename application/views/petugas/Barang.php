                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>                                
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= site_url('petugas/barang/'.$value->barang_id.'/view'); ?>" rel="tooltip" title="Edit Task" class="btn btn-primary btn-link btn-sm">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= site_url('petugas/tambahBarang'); ?>" method="post">

            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header card-header-warning">
                        <h4 class="card-title">Data Barang Keluar<a href="<?= site_url('petugas/printBarangKeluar'); ?>" class="btn btn-info float-right">Cetak Laporan</a><button type="button" data-toggle="modal" data-target="#modalSupplier" class="btn btn-rose float-right">Tambah Data</button></h4>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $value->total; ?></td>
                                    <td>
                                        <a href="<?= site_url('petugas/barang_keluar/'.$value->id.'/view'); ?>" rel="tooltip" title="Edit Task" class="btn btn-primary btn-link btn-sm">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <form action="<?= site_url('petugas/tambahBarangKeluar'); ?>" method="post">

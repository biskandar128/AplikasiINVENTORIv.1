                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= site_url('petugas/barang_masuk/'.$value->id.'/view'); ?>" rel="tooltip" title="Edit Task" class="btn btn-primary btn-link btn-sm">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                <form action="<?= site_url('petugas/tambahBarangMasuk'); ?>" method="post">
